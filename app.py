...
st.markdown("""
    ...
    /* --- КНОПКА ПО ЦЕНТРУ (FLEXBOX) --- */
    /* Цей блок змушує кнопку бути по центру незалежно від колонок */
    div.stButton {
        display: flex;
    ...
    /* Стиль самої кнопки */
    .stButton>button {
        width: auto !important; /* Автоматична ширина під текст */
        min-width: 300px;       /* Але не менше 300px */
        background: linear-gradient(90deg, #FF8C00 0%, #FF4500 100%);
        color: white;
        border-radius: 12px;
        font-weight: bold;
        padding: 12px 24px;     /* Нормальна товщина */
        font-size: 18px;
        border: none;
...
# ВАКАНСІЯ (Без номера, з підписом)
with c1:
...
# КАНДИДАТИ (Без номера, з підписом, з вкладками)
with c2:
...
# --- КНОПКА (ТЕПЕР ЦЕНТРУЄТЬСЯ ЧЕРЕЗ CSS) ---
# Ми не використовуємо колонки для позиціонування, бо CSS (рядок 65) робить це краще.
